...
import dragButton from '@/promotionpages/components/drag-button/drag-button.vue';
import diyWholeSale from '@/promotionpages/components/diy-wholesale/diy-wholesale.vue';
export default {
	components: {
		dragButton,
		diyWholeSale
